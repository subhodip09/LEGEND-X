...
PM_START_TEXT = """
Hello there, I'm [ＮＩＣＫＹ](https://telegra.ph/file/0055e1c9656a65fbd7c92.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add NICKY to your group 💫",
            url="t.me/Tomiko_Nicky_bot?startgroup=true",
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [NICKY](https://telegra.ph/file/0055e1c9656a65fbd7c92.jpg)
...
Support them  [N](t.me/nicky_support,[NICKY](t.me/nicky_support),"""
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by @Smile_of_your_face .* "
            f"\n\n 🔥 Join [NICKY](https://t.me/nicky_support) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/0055e1c9656a65fbd7c92.jpg)"
